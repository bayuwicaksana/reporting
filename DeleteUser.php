...
<form action="./daftaruser.php" method="POST">
			Apakah data user berikut akan dihapus? 
			...
			<table style="border-collapse: separate; border-spacing: 3px 3px;">
				...
				<tr>
					...
					<td> &nbsp; : &nbsp; </td>
					<td> <input name="password" title="password" class="form-control" readonly value="<?php echo $password ?>" size="30" maxlength="2048" /></td>
				</tr>
				<tr>
					<td><font face="arial" size=2px> Group</font></td>
					<td> &nbsp; : &nbsp; </td>
					<td> 
						<select name="grup" id="grup" class="form-control"  readonly >
				...
				<tr>
					<td> </td>
					<td> </td>
					<td> <input type="submit" name="submit" value="Hapus" class="btn btn-primary" /> &nbsp; <INPUT TYPE="button" value="Batal" onClick="parent.location='daftaruser.php'" class="btn btn-primary"> </td>
				</tr>
